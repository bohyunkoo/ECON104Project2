...
```{r}
lpm_model <- lm(diabetes ~ age + bmi + gender + hypertension + heart_disease + smoking_history, 
                data = diab_data)
summary(lpm_model)
bptest(lpm_model)
...
logit_model <- glm(diabetes ~ age + bmi + gender + hypertension + heart_disease + smoking_history, 
                   data = diab_data, family = binomial(link = "logit"))
summary(logit_model)

probit_model <- glm(diabetes ~ age + bmi + gender + hypertension + heart_disease + smoking_history, 
